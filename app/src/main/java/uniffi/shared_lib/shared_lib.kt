...
open class RustBuffer : Structure() {
    ...
    companion object {
        internal fun alloc(size: Int = 0) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_lib_bc9b_rustbuffer_alloc(size, status).also {
                if(it.data == null) {
        ...
        internal fun free(buf: RustBuffer.ByValue) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_lib_bc9b_rustbuffer_free(buf, status)
        }

        internal fun reserve(buf: RustBuffer.ByValue, additional: Int) = rustCall() { status ->
            _UniFFILib.INSTANCE.ffi_shared_lib_bc9b_rustbuffer_reserve(buf, additional, status)
        }
    }
...
internal interface _UniFFILib : Library {
    companion object {
        internal val INSTANCE: _UniFFILib by lazy {
            loadIndirect<_UniFFILib>(componentName = "shared_lib")
            
            
        }
    }

    fun shared_lib_bc9b_add(a: Int,b: Int,
    _uniffi_out_err: RustCallStatus
    ): Int

    fun ffi_shared_lib_bc9b_rustbuffer_alloc(size: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_lib_bc9b_rustbuffer_from_bytes(bytes: ForeignBytes.ByValue,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_lib_bc9b_rustbuffer_free(buf: RustBuffer.ByValue,
    _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_shared_lib_bc9b_rustbuffer_reserve(buf: RustBuffer.ByValue,additional: Int,
    _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
...
fun add(a: UInt, b: UInt ): UInt {
    ...
    rustCall() { _status ->
    _UniFFILib.INSTANCE.shared_lib_bc9b_add(FfiConverterUInt.lower(a), FfiConverterUInt.lower(b) , _status)
})
}
