...
internal interface _UniFFILib : Library {
    ...
    fun shared_lib_bc9b_add(
        a: Int,
        b: Int,
        _uniffi_out_err: RustCallStatus
    ): Int

    fun ffi_shared_lib_bc9b_rustbuffer_alloc(
        size: Int,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_lib_bc9b_rustbuffer_from_bytes(
        bytes: ForeignBytes.ByValue,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue

    fun ffi_shared_lib_bc9b_rustbuffer_free(
        buf: RustBuffer.ByValue,
        _uniffi_out_err: RustCallStatus
    ): Unit

    fun ffi_shared_lib_bc9b_rustbuffer_reserve(
        buf: RustBuffer.ByValue,
        additional: Int,
        _uniffi_out_err: RustCallStatus
    ): RustBuffer.ByValue
