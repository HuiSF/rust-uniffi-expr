...
#if canImport(shared_libFFI)
    import shared_libFFI
#endif
...
private extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_shared_lib_bc9b_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_shared_lib_bc9b_rustbuffer_free(self, $0) }
    }
}
...
public func add(a: UInt32, b: UInt32) -> UInt32 {
    let _retval = try!
        ...
        rustCall {
            shared_lib_bc9b_add(a.lower(), b.lower(), $0)
        }
 ...
 */
public enum SharedLibLifecycle {
    /**
